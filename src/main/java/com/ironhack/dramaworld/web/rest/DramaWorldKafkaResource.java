...
@RestController
@RequestMapping("/api/drama-world-kafka")
public class DramaWorldKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DramaWorldKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DramaWorldKafkaResource(KafkaProperties kafkaProperties) {
